...
And, on the makeup front, Rihanna''s Fenty makeup artist revealed the look for the artist at the Met Gala. To no surprise, it''s all about the skin to get that red carpet ready look down to a T.', '2_molly-mae_hague.webp');
